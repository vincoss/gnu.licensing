...
using Warthog.Sample_Console_ServerLicenseFetch.Services;
using Warthog.Validation;


namespace Warthog.Sample_Console_ServerLicenseFetch
{
    /// <summary>
    /// NOTE: Ensure that the 'Warthog.Api' service is running.
    /// </summary>
    class Program
    {
