...
dotnet dev-certs https -ep %USERPROFILE%\.aspnet\https\Warthog.Api.pfx -p todo-Pass@word1
dotnet dev-certs https --clean
dotnet dev-certs https --trust
dotnet user-secrets -p src\Warthog.Api\Warthog.Api.csproj set "Kestrel:Certificates:Password" "todo-Pass@word1"
